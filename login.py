...
ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\TaysaMarkAnthony(Stu\Desktop\Arisuu-main\ASSETS\Login_assets\frame0")
...
entry_1 = Entry(bd=0, bg="#97BCC7", fg="#000716", highlightthickness=0,font=("Times New Roman", 20))
...
entry_2 = Entry(bd=0, bg="#97BCC7", fg="#000716", highlightthickness=0,font=("Times New Roman", 20),show="*")
